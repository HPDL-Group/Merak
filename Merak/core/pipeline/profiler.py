...
class FlopsProfiler(object):
    ...
    def print_model_profile(self,
        ...
        global func_flops
        print('function flops', func_flops)
        func_flops = {}
...
def _matmul_flops_compute(input, other, *, out=None):
    ...
    # if torch.distributed.get_rank()==0: print(2*macs)
...
def _baddbmm_flops_compute(input, mat1, mat2, *, beta=1, alpha=1, out=None):
    """
